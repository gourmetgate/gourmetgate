...
import app.gourmetgate.gourmetgate.data.category.CategoryResponse;
...
public class CategoryResource implements IRestResource {
  ...
  public CategoryResponse getAll(@DefaultValue("true") @QueryParam("onlyAvailable") boolean onlyAvailable) {
    return BEANS.get(CategoryResponse.class)
