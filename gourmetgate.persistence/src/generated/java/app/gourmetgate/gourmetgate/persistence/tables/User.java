...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, UUID> USER_ID = createField(DSL.name("user_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>public.user.status</code>.
     */
    public final TableField<UserRecord, String> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR(80).nullable(false).defaultValue(DSL.field(DSL.raw("'ACTIVE'::character varying"), SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<UserRecord, String> SALT = createField(DSL.name("salt"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.user.sort_code</code>.
     */
    public final TableField<UserRecord, OffsetDateTime> SORT_CODE = createField(DSL.name("sort_code"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
